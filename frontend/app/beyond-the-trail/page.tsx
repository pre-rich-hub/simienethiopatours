...
// These image paths are intentionally centralized so the final photography can be swapped in one place.
const featuredExperiences: readonly ExperiencePhotoItem[] = [
  { ...experienceLinks[0], image: { src: "/images/fasil-ghebbi.jpg", alt: "The royal stone architecture of Fasil Ghebbi in Gondar", caption: "Royal Gondar → Simien" } },
  { ...experienceLinks[1], image: { src: "/images/imet-gogo.jpg", alt: "Layered escarpments along the longer Simien expedition route", caption: "Escarpment → Ras Dashen" } },
  { ...experienceLinks[2], image: { src: "/images/road-to-simien.jpg", alt: "Community life in the northern Ethiopian highlands", caption: "Living culture · Northern Ethiopia" } },
  { ...experienceLinks[3], image: { src: "/images/road-to-simien.jpg", alt: "Open country and quiet paths outside Gondar", caption: "Gondar · Paths beyond the city" } },
  { ...experienceLinks[4], image: { src: "/images/simien-panorama.jpg", alt: "Wide Simien Mountain landscape in changing highland light", caption: "Landscape · Wildlife · Light" } },
  { ...experienceLinks[5], image: { src: "/images/tevan-founder.jpg", alt: "A local guide sharing northern Ethiopia through personal experience", caption: "Gondar · Through local eyes", position: "center 28%" } },
];
...
const localExperiences: readonly ExperiencePhotoItem[] = [
  ...
  { title: "Gondar & Kosoye", tag: "City · Country · View", body: "Move from the royal city into countryside, rural walking routes and highland views. Connect the city with the people and landscapes around it.", href: "/plan?experience=kosoye", linkLabel: "Explore Kosoye", image: { src: "/images/simien-panorama.jpg", alt: "Highland views in the country beyond Gondar", caption: "Gondar → Kosoye highlands" } },
];
