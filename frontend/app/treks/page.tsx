...
export default async function TreksPage() {
  ...
  return <PageShell lightHeader={false}>
    ...
    <section className="section section--paper"><div className="shell"><SectionIntro tag="Culture, light and mountain days" title="Connect the" accent="chapters." /><FeatureGrid columns={2} items={[
      ...
      { title: "Photography journeys", tag: "1–5 days", body: "Create more time for wildlife, landscapes and the changing light on a photography-focused mountain journey.", href: "/gallery" },
      { title: "Gondar beyond the trail", tag: "Make the journey your own", body: "Add festivals, local food, running, village experiences and time to discover Gondar.", href: "/gondar" },
    ]} /></div></section>
