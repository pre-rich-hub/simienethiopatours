...
export const classicJourneys: JourneyDetail[] = [
  ...
  },
  {
    ...
    highlights: mountainHighlights, preparation: [...mountainPreparation, "The final day combines walking and the return drive. Discuss onward flight timing before booking, and allow extra days for a summit objective."],
  ...
  },
  {
    ...
    preparation: [...mountainPreparation, "Arrival time determines how much Gondar sightseeing fits on day one. Add a city night if you want a fuller heritage programme. A final hotel night after the return is an extra arrangement."],
  ...
  },
  {
    ...
    notice: "This outline ends back at Ambiko after the summit attempt on day five. It is not a five-day return trip to Gondar. The complete duration, additional nights, acclimatization and exit route must be agreed before booking.",
