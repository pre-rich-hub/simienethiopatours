...
import { AtAGlance, EditorialHero, Itinerary, PageLinks, PlanningCall, SectionIntro, StorySection } from "@/components/Editorial";
...
// Replace the image paths here as dedicated festival photography becomes available.
const festivals: readonly ExperiencePhotoItem[] = [
  { title: "Timkat & Simien", tag: "6 days / 5 nights", body: "The signature festival journey: Gondar’s Timkat celebration followed by two mountain nights and a full day in Simien.", href: "/plan?experience=timkat-simien", linkLabel: "Plan Timkat & Simien", image: { src: "/images/fasil-ghebbi.jpg", alt: "Historic Fasil Ghebbi in Gondar, the city where the Timkat journey begins", caption: "Gondar celebration → Simien" } },
  { title: "Timkat & Ras Dashen", tag: "Suggested 8–10 days", body: "Combine the festival with a demanding multi-day mountain journey toward Ras Dashen. Duration and acclimatization plans are tailored to your experience and the chosen route.", href: "/plan?experience=timkat-ras-dashen", linkLabel: "Plan festival & summit", image: { src: "/images/giant-lobelia.jpg", alt: "High Afroalpine landscape on a longer Simien journey", caption: "Living culture → High country" } },
  { title: "Genna & Simien", tag: "Suggested 6–8 days", body: "Experience Ethiopian Christmas and local cultural life before entering the mountains. Choose the places and pace that suit your interests.", href: "/plan?experience=genna-simien", linkLabel: "Plan Genna & Simien", image: { src: "/images/road-to-simien.jpg", alt: "Daily life in the northern Ethiopian highlands", caption: "Local tradition → Mountain road" } },
  { title: "Meskel & Simien", tag: "September celebration", body: "Connect Meskel’s traditions with Gondar and the highlands. A journey through living culture, local interpretation and mountain landscapes.", href: "/plan?experience=meskel-simien", linkLabel: "Plan Meskel & Simien", image: { src: "/images/fasil-ghebbi.jpg", alt: "Gondar's historic architecture as part of a cultural journey", caption: "Gondar · Culture · Highlands" } },
  { title: "Enkutatash & Simien", tag: "Ethiopian New Year", body: "Build a more intimate local celebration into a journey through Gondar, highland wildlife and mountain trails.", href: "/plan?experience=enkutatash-simien", linkLabel: "Plan New Year in the highlands", image: { src: "/images/simien-panorama.jpg", alt: "Wide highland views in the Simien Mountains", caption: "A new year in the highlands" } },
];

export default function FestivalsPage() {
  return <PageShell lightHeader={false}>
    <EditorialHero eyebrow="Ethiopian festivals & holiday journeys" title="Living culture." accent="Mountain journeys." lead="Experience Ethiopia’s meaningful celebrations with local interpretation, then follow the road from historic Gondar into the Simien highlands." image={{ src: "/images/fasil-ghebbi.jpg", alt: "Historic Gondar, the starting place for a festival and mountain journey" }} />
    ...
    <section className="section" id="celebrations"><div className="shell"><SectionIntro tag="Festival → Gondar → Simien" title="Choose your" accent="celebration." /><ExperiencePhotoCards items={festivals} /></div></section>
    <StorySection id="respect" tag="Our festival philosophy" title="Understand what" accent="you are witnessing." paper image={{ src: "/images/tevan-founder.jpg", alt: "A local guide who provides cultural context for a northern Ethiopia journey", caption: "Local interpretation · Respectful travel", position: "center 28%" }} paragraphs={[
