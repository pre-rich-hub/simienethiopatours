...
export default function RunningPage() {
  return <PageShell>
    <EditorialHero eyebrow="Gondar hidden running experience" title="Run Gondar." accent="Discover another side." lead="The city is your starting line. The countryside is your trail. Follow quieter paths, farmland and highland views with a local guide who knows the way." />
    ...
    <StorySection tag="From city to countryside" title="Watch Gondar change" accent="as you move." paragraphs={[
    ...
    <section className="section section--paper" id="pace"><div className="shell"><SectionIntro tag="Your pace. Your experience." title="Choose the run" accent="that feels like you." /><FeatureGrid items={[
      { title: "Easy", tag: "Shorter · Gentler", body: "A relaxed run or walk with room for sightseeing, local stories and pauses. A good starting point when you want to move without chasing a workout.", href: "/plan?experience=gondar-running", linkLabel: "Plan an easy outing" },
      { title: "Active", tag: "Moderate · Mixed terrain", body: "A more sustained run through local paths and countryside, with distance and effort agreed around your regular running experience.", href: "/plan?experience=gondar-running", linkLabel: "Plan an active run" },
      { title: "Trail", tag: "Longer · More elevation", body: "Hills, natural surfaces and a greater challenge for experienced runners. Terrain, elevation and the available time shape the route.", href: "/plan?experience=gondar-running", linkLabel: "Plan a trail run" },
